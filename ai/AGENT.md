...
You should write data to `/tmp/ai/canvas_data.json` before running canvas_wrapper.
...
### Output
`canvas` command outputs user stats to `/tmp/ai/canvas.txt`. Read the file with your read file tool.
Output format:
```txt
