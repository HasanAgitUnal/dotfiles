...

        {
...

                        {
                                ...
                                config = function()
                                        ...
                                        cmp.setup({
                                                ...
                                                window = {
                                                        completion = { border = 'none', winhighlight = 'Normal:CmpPmenu,CursorLine:PmenuSel,Search:None' },
                                                        documentation = { border = 'none', winhighlight = 'Normal:CmpPmenu,CursorLine:PmenuSel,Search:None' },
                                                },
                                        })
                                end
                        },
                ...
                config = function()
                        ...
                        for server_name, _ in pairs(servers or {}) do
                                if server_name ~= "clangd" then table.insert(ensure_installed, server_name) end
                        end
