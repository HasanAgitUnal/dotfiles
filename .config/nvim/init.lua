...
require('lazy').setup({
   {
     ...
     config = function()
       require("nvim-tree").setup({
         filesystem_watchers = { enable = true }, -- Hızlı dosya takibi
         actions = { open_file = { quit_on_open = true } } -- Dosyayı açınca kapat (RAM dostu)
       })
     end
   },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- vim.cmd('hi! link MiniStatuslineInactive Function')
